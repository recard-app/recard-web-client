  ...
  overlay.innerHTML = `
    ...
    ">
      <div style="display: flex; flex-direction: column; align-items: center; gap: 12px;">
        ...
        <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="${tc.neutralDarkGray}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" style="animation: pwa-spin 1s linear infinite;">
