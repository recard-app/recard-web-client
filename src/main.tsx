  ...
  overlay.innerHTML = `
    ...
    ">
      ...
      <span style="
        ...
        font-size: 13px; font-weight: 400; color: #5A5F66;
      ">App Updating...</span>
    </div>
