...
const SignOutIcon: React.FC<BaseIconProps> = ({ 
  variant = 'solid',
  ...
  // Render solid sign out icon (24x24)
  ...
  // Render outline sign out icon (24x24)
  ...
  // Render mini sign out icon (20x20)
  ...
  // Render micro sign out icon (16x16)
