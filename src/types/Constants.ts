...
export const PLACEHOLDER_CARD_PRIMARY_COLOR = COLORS.NEUTRAL_GRAY;
export const PLACEHOLDER_CARD_SECONDARY_COLOR = COLORS.NEUTRAL_LIGHT_GRAY;
export const PLACEHOLDER_ASSISTANT_IMAGE = '/lotus.svg';
export const HISTORY_PAGE_SIZE = 20;
export const MAX_CHAT_MESSAGES = 20;
export const MAX_CHAT_THREAD_MESSAGES = 50;
...
export const DEFAULT_CHAT_NAME_PLACEHOLDER = 'New Chat';
...
export const PAGE_NAMES = {
    HOME: 'Home',
    TRANSACTION_HISTORY: 'Previous Chats',
    MY_CARDS: 'My Cards',
    MY_CREDITS: 'My Credits',
    NEW_TRANSACTION_CHAT: 'New Chat',
...
export const ICON_BLUE = COLORS.ACCENT_COLOR;
...
export const PAGE_ICONS = {
    ...
    TERMS_OF_SERVICE: {
        ACTIVE: (props: any = {}) => createIconVariant('document-text', 'solid', SIDEBAR_ACTIVE_ICON_COLOR, props.size),
        INACTIVE: (props: any = {}) => createIconVariant('document-text', 'outline', SIDEBAR_INACTIVE_ICON_COLOR, props.size),
        MINI: (props: any = {}) => createIconVariant('document-text', 'mini', ICON_PRIMARY, props.size)
    },
    PRIVACY_POLICY: {
        ACTIVE: (props: any = {}) => createIconVariant('document-text', 'solid', SIDEBAR_ACTIVE_ICON_COLOR, props.size),
        INACTIVE: (props: any = {}) => createIconVariant('document-text', 'outline', SIDEBAR_INACTIVE_ICON_COLOR, props.size),
...
export const INFO_BG_COLORS = {
    DEFAULT: 'transparent',
    ERROR: COLORS.INFO_ERROR_BG,
    INFO: COLORS.INFO_BLUE_BG,
    WARNING: COLORS.INFO_WARNING_BG,
    SUCCESS: COLORS.INFO_SUCCESS_BG,
    LOADING: 'transparent'
} as const;

export const INFO_BORDER_COLORS = {
    DEFAULT: 'transparent',
    ERROR: COLORS.INFO_ERROR_BORDER,
    INFO: COLORS.INFO_BLUE_BORDER,
    WARNING: COLORS.INFO_WARNING_BORDER,
    SUCCESS: COLORS.INFO_SUCCESS_BORDER,
    LOADING: 'transparent'
} as const;
